...
public class ModTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> SHROOMBRIGHT_TEARS_GROWABLE = create("shroombright_tears_growable_on");
        public static final TagKey<Block> PHOSPHOR_SHROOMLIGHT_TEARS_GROWABLE = create("phosphor_shroomlight_tears_growable_on");
