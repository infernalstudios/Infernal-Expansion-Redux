...
public class GlowsquitoRenderer extends MobRenderer<GlowsquitoEntity, GlowsquitoModel<GlowsquitoEntity>> {
    protected static final ResourceLocation UNBRED_TEXTURE = new ResourceLocation(IEConstants.MOD_ID,
            "textures/entity/glowsquito.png");

    protected static final ResourceLocation BRED_TEXTURE = new ResourceLocation(IEConstants.MOD_ID,
            "textures/entity/glowsquito_shroomlight.png");
