...
public class VolineRenderer extends GeoEntityRenderer<VolineEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, VolineEntity animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
